...
var Funcionarios = /** @class */ (function () {
    function Funcionarios(nome, salarioHora, diasTrabalhados, totalFaltasNoAno) {
        this.nome = nome;
    ...
    Funcionarios.prototype.getTotalFaltasNoAno = function () {
    ...
    Funcionarios.prototype.setTotalFaltasNoAno = function (totalFaltasNoAno) {
    ...
    Funcionarios.prototype.calculoPLR = function () {
        var plr = 0;
    ...
    Funcionarios.prototype.calculoDesconto = function () {
        return (this.SalarioBruto() / 100) * 5;
    };
    Funcionarios.prototype.calculoSalarioLiquido = function () {
        return this.SalarioBruto() + this.calculoPLR() - this.calculoDesconto();
    };
    Funcionarios.prototype.Mensagens = function () {
...
var funcionario = new Funcionarios('Rafaella', 100, 220, 2);
try {
    funcionario.setNome('');
